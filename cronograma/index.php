...
<html lang="pt-BR">
    <head>
        <title>MA225 - Análise de Livros e Materiais Didáticos</title>

        <?php include('../assets/php/head.php'); ?>

        <link rel="preload" as="style" onload="this.remove();" href="../assets/css/home.css?t=<?php echo date('YmdHis'); ?>" type="text/css">
        <link rel="stylesheet" href="../assets/css/home.css?t=<?php echo date('YmdHis'); ?>" type="text/css">
